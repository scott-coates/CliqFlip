...
var cliqFlipRaphael = {
	cliqFlipCreateMindMapBubble: function(passion, x, y, fill, text, userInterestId, canEdit, cb) {
	...
	cliqFlipQuotationMarks: function(xAxis) {
...
$.extend(Raphael.fn, cliqFlipRaphael);
