(function (window, document, navigator, l) {
    //l == options?
    //console.dir(m);
    //console.dir(n);
    console.dir(l);
        ...
        f: function () {
            return {
                ...
                hazTag: {
                    ...
                    meta: function (b) {
                        var c, d, e;
                        if (b.name && b.name.toUpperCase() === "PINTEREST" && b.content && b.content.toUpperCase() === "NOPIN") if (e = b.getAttribute("description")) {
                            d = "The owner of the site";
                            c = a.d.URL.split("/");
                            if (c[2]) d = c[2];
                            a.f.close(a.a.msg.noPinReason.replace(/%s%/, d) + "\n\n" + e)
                        } else a.f.close(a.a.msg.noPin);
                        if ((c = b.getAttribute("property")) && c.toUpperCase() === "OG:IMAGE" && b.content) a.v.ogImage = b.content.split("?")[0]
                    }
                },
                checkTags: function () {
                ...
                checkUrl: function () {
                    var b;
					//a.a.url is an array of regular expressions
                    for (b in a.a.url)
					{
    ...
    k: "PIN_" + (new Date).getTime(), //a unique key, the key will be used to store the bookmarklet in the window object
    checkpoint: {
